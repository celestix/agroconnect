...
class _CropsPageState extends State<CropsPage> {
  ...
  List<Widget> _buildFilteredSections() {
    ...
    _addSection(
      sections,
      title: 'Sugarcane',
      imagePath: 'images/Sugarcane.webp',
      description:
    ...
    //   sections,
    //   title: 'Cabbage',
    //   imagePath: 'assets/cabbage_image.jpg',
    //   description: 'Description for Cabbage',
    // );
